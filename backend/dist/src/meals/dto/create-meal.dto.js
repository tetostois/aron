...
class CreateMealDto {
    ...
    description;
    price;
    category = meal_entity_1.MealCategory.MAIN;
    imageUrl;
    isAvailable = true;
    restaurantId;
}
...
__decorate([
    (0, class_validator_1.IsEnum)(meal_entity_1.MealCategory),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
...
], CreateMealDto.prototype, "isAvailable", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateMealDto.prototype, "restaurantId", void 0);
