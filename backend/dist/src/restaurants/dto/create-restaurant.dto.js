...
__decorate([
    ...
    (0, class_validator_1.Min)(-90, { message: 'La latitude doit être comprise entre -90 et 90 degrés' }),
    (0, class_validator_1.Max)(90, { message: 'La latitude doit être comprise entre -90 et 90 degrés' }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
], CreateRestaurantDto.prototype, "latitude", void 0);
__decorate([
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.Min)(-180, { message: 'La longitude doit être comprise entre -180 et 180 degrés' }),
    (0, class_validator_1.Max)(180, { message: 'La longitude doit être comprise entre -180 et 180 degrés' }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
...
], CreateRestaurantDto.prototype, "coordinates", void 0);
__decorate([
